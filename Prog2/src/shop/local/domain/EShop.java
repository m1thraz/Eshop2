...
public class EShop implements Serializable {
	...
	//----------------------------------------------ArtikelVerwaltung-------------------------------------------------------
	 ...
	 public List<Artikel> gibArtikelListeAusKunde(int eingabe) {
	 ...
	 public Artikel fuegeArtikelEin(String titel, int artNr, double preis, int bestand, int einheit)  throws ArtikelNrSchonVorhandenException {
	 ...
	 public int getBestandVonArtikel(int artNr) throws ArtNrNichtVorhandenException {
	...
	//----------------------------------------------KundenVerwaltung-------------------------------------------------------
	 ...
	 public void registrieren(String vorname, String nachname, String loginName,  String passwort, Adresse adresse) throws KundeBereitsVorhandenException, IOException {
	...
	//----------------------------------------------MitarbeiterVerwaltung-------------------------------------------------------
	 ...
	 public void fuegeMitarbeiterEin(String loginName, String vorname, String nachname, String pw) throws  IOException, MitarbeiterExistiertBereitsException {
	        meineMitarbeiter.einfuegen(new Mitarbeiter(loginName, vorname, nachname, pw));
	        schreibeMA();
	 }
	 
	 public void schreibeMA() throws IOException {
			meineMitarbeiter.schreibeDaten(datei+"_M.txt");
	 }
	//----------------------------------------------WarenkorbVerwaltung-------------------------------------------------------
	  
	 public Warenkorb warenHinzufuegen(Artikel artikel, Kunde kunde, int menge) throws MassengutartikelException, ArtikelBestandReichtNichtAusException {		
	 ...
	 public void kaufAbschliessen(Kunde kunde) {
		meineWarenkorbVerwaltung.kaufAbschliessen(kunde);	
	 }		
}

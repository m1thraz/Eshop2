...
public class ShopCuiClient {
	...
	private void verarbeiteEingabe(String input) throws IOException, ArtikelSchonVorhandenException, LoginUngueltigException, ArtikelNrSchonVorhandenException, KundeBereitsVorhandenException {
	...
	private void run() throws ArtikelSchonVorhandenException, ArtikelNrSchonVorhandenException, KundeBereitsVorhandenException {
			String input = ""; 
